"""
Middleware class to enable the admin form to redirect to the openid login page
This has to be implemented this way as the form has no way to cause a redirect
through the normal mechanisms as it does not return a HTTPResponse
"""
